...
\begin{document}
    ...
    3D computer vision; 4D scene reconstruction; Dense motion tracking; Spectral learning w/ deep functional maps network (FMNet); Human-computer interaction; AI for healthcare.
    ...
    \resumeSubHeadingListStart
        ...
        \resumeSubheading
            {pedarProbe}{2022}
            {Data analysis framework for pedar plantar pressure sensor}{\paralink{https://github.com/liu-qilong/pedarProbe}{Link}}
        \resumeSubheading
