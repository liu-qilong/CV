...
\usepackage{etoolbox}  % tools for custom commands
...
\newcommand{\links}{}
\newcommand{\addlink}[2]{\appto{\links}{\href{#1}{#2} }}  % #1: link #2: text
\newcommand{\placelinks}{\links}
...
% resume columns
\newcommand{\resumeColumnsStart}{\begin{itemize}[leftmargin=0.15in, label={}]}
\newcommand{\resumeColumnsEnd}{\end{itemize}\vskip5pt}
